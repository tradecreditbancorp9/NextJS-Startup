...
const SignupPage = () => {const [formData, setFormData] = useState({
  name: "",
  email: "",
  password: "",
});
...
const handleSubmit = async (e) => {
  ...
  if (res.ok) {
    ...
    router.push("/");// Redirect to the sign-in page after successful signup
  } else {
    ...
    <>
      ...
      <div className="mb-8 flex">
        ...
        >
          ...
          />
          I agree to the{" "}
          <a href="#0" className="text-primary hover:underline mx-1">
            Terms
          </a>
          and{" "}
          <a href="#0" className="text-primary hover:underline ml-1">
            Privacy Policy
          </a>
        </label>
      </div>

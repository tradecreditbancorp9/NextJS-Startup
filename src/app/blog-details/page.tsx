...
export const metadata: Metadata = {
  title: "Bank Securities Overview | TradeCreditBancorp Blog",
  description: "Learn how TradeCreditBancorp partners with leading banks to deliver a full spectrum of bank securities and trade finance solutions.",
};
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  TradeCreditBancorp: Your Partner for Bank Securities & Trade Finance
                </h2>
                <div className="border-body-color/10 mb-10 flex flex-wrap items-center justify-between border-b pb-4 dark:border-white/10">
                  <div className="flex flex-wrap items-center">
                    <div className="mr-10 mb-5 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="text-body-color mb-1 text-base font-medium">
                          By <span>TradeCreditBancorp</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center">
                      ...
                      <p className="text-body-color mb-5 flex items-center text-base font-medium">
                        <span className="mr-3">
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium">
                    With a global footprint and deep banking relationships, TradeCreditBancorp delivers a complete suite of bank‐backed securities to help you manage risk, optimize working capital, and support cross‐border trade.
                  </p>
                  <h3 className="font-xl mb-6 leading-tight font-bold text-black sm:text-2xl dark:text-white">
                    Our Core Bank Securities Offerings
                  </h3>
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li className="mb-2 text-base font-medium">
                      <strong>Letters of Credit (LCs):</strong> Secure payment guarantees for importers and exporters.
                    </li>
                    <li className="mb-2 text-base font-medium">
                      <strong>Bank Guarantees:</strong> Performance and financial guarantees to back contractual obligations.
                    </li>
                    <li className="mb-2 text-base font-medium">
                      <strong>Non-Convertible Debentures (NCDs):</strong> Fixed‐income instruments with competitive yields.
                    </li>
                    <li className="mb-2 text-base font-medium">
                      <strong>Trade Credit Insurance:</strong> Protection against buyer default and political risk.
                    </li>
                  </ul>
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8">
                    <p className="text-body-color text-center text-base font-medium italic">
                      “Our tailored bank‐backed solutions empower clients to transact with confidence—anywhere in the world.”
                    </p>
                  </div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium">
                    Whether you’re a multinational corporation or a growing SME, our expert team will design and execute the right mix of bank securities—leveraging our banking partners’ credit lines to optimize your cash flow and mitigate risk.
                  </p>
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      <h4 className="text-body-color mb-3 text-sm font-medium">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Banking" />
                        <TagButton text="Trade Finance" />
                        <TagButton text="Securities" />
                      </div>
                    </div>
                    <div className="mb-5">
                      <h5 className="text-body-color mb-3 text-sm font-medium sm:text-right">
